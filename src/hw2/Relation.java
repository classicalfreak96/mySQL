...
//				System.out.println("size of joinkey is: " + joinKey.size());
...
//				}
//				for (int i = 0; i < other.td.numFields(); i++) {
//					newTuple.setField(counter, other.getTuples().get(joinKey.indexOf(tuple.getField(field1)) + increaser).getField(i));
//				}
